<template>
  <div class="home">
    <div class="nav-bar">
      ...
      <div class="family item2" @click="goFamily">+</div>

      <transition name="fadeIn">
        <div class="family2" v-if="isShowFamily">
          分类    <div class="close-family" @click="goFamily">关闭</div>
        </div>
      </transition>
...
<script>
  ...
  export default {
    ...
    mounted() {
      console.log(this.homeListDates);
      this.swiper1.on(
        "init", function (e) {
